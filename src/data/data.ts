    ...
    about:
      {
        heading:
          'My story so far',
        subheading:
          'Scroll through a few moments that shaped how I build.',
        slides:
          [
            {
              id: 'curiosity',
    ...
    portfolio:
      {
        heading:
          'Selected work',
        subheading:
          "A few projects I've designed, built, or shipped.",
        projects:
          [
            {
              ...
              links:
                {
                  github:
                    'https://github.com/aaqibqadeer/aaqibqadeerportfolio',
                  liveDemo:
                    'https://aaqibqadeer.dev'
                },
              detail:
                {
                  overview:
              ...
              links:
                {
                  ...
                  github:
                    'https://github.com/aaqibqadeer/flow'
                },
              detail:
                {
                  overview:
            ...
            },
            {
              ...
              title:
                'skycast',
              description:
                'A tiny, fast weather CLI for your terminal.',
              thumbnail:
                {
              ...
              links:
                {
                  github:
                    'https://github.com/aaqibqadeer/skycast'
                },
              detail:
                {
                  overview:
              ...
              links:
                {
                  ...
                  github:
                    'https://github.com/aaqibqadeer/atlas',
                  liveDemo:
